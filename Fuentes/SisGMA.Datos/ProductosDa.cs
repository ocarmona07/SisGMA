...
namespace SisGMA.Datos
{
    ...
    public class ProductosDa : BaseEntity
    {
        ...
        public Productos Get(int idItem)
        {
            try
            {
                return _sisGmaEntities.Productos.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public Productos Update(Productos item)
        {
            try
            {
                _sisGmaEntities.Productos.Attach(item);
        ...
        public bool Delete(int idItem)
        {
            try
            {
                var entry = _sisGmaEntities.Productos.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
