...
namespace SisGMA.Datos
{
    ...
    public class RolesDa : BaseEntity
    {
        ...
        public Roles Insert(Roles item)
        {
            try
            {
                _sisGmaEntities.Roles.Add(item);
        ...
        public Roles Get(int idItem)
        {
            try
            {
                return _sisGmaEntities.Roles.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public Roles Update(Roles item)
        {
            try
            {
                _sisGmaEntities.Roles.Attach(item);
        ...
        public bool Delete(int idItem)
        {
            try
            {
                var entry = _sisGmaEntities.Roles.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
