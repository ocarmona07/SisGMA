...
namespace SisGMA.Datos
{
    ...
    public class ModeloVehiculosDa : BaseEntity
    {
        private readonly SisGMAEntities _sisGmaEntities;

        public ModeloVehiculosDa()
        {
            IsValid = true;
        ...
        public ModeloVehiculos Insert(ModeloVehiculos item)
        {
            try
            {
                _sisGmaEntities.ModeloVehiculos.Add(item);
        ...
        public ModeloVehiculos Get(int idItem)
        {
            try
            {
                return _sisGmaEntities.ModeloVehiculos.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public List<ModeloVehiculos> GetAll()
        {
            try
            {
        ...
        public ModeloVehiculos Update(ModeloVehiculos item)
        {
            try
            {
                _sisGmaEntities.ModeloVehiculos.Attach(item);
        ...
        public bool Delete(int idItem)
        {
            try
            {
                var entry = _sisGmaEntities.ModeloVehiculos.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
