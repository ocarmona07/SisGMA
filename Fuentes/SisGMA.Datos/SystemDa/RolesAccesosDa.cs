...
namespace SisGMA.Datos
{
    ...
    public class RolesAccesosDa : BaseEntity
    {
        private readonly SisGMAEntities _sisGmaEntities;

        public RolesAccesosDa()
        {
            IsValid = true;
        ...
        public RolesAccesos Insert(RolesAccesos item)
        {
            try
            {
                _sisGmaEntities.RolesAccesos.Add(item);
        ...
        public RolesAccesos Get(int idItem)
        {
            try
            {
                return _sisGmaEntities.RolesAccesos.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public List<RolesAccesos> GetAll()
        {
            try
            {
                return _sisGmaEntities.RolesAccesos.ToList();
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public RolesAccesos Update(RolesAccesos item)
        {
            try
            {
                _sisGmaEntities.RolesAccesos.Attach(item);
        ...
        public bool Delete(int idItem)
        {
            try
            {
                var entry = _sisGmaEntities.RolesAccesos.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
