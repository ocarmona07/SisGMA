...
namespace SisGMA.Datos
{
    ...
    public class RegionesDa : BaseEntity
    {
        ...
        public Regiones Insert(Regiones item)
        {
            try
            {
                _sisGmaEntities.Regiones.Add(item);
        ...
        public Regiones Get(int idItem)
        {
            try
            {
                return _sisGmaEntities.Regiones.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public Regiones Update(Regiones item)
        {
            try
            {
                _sisGmaEntities.Regiones.Attach(item);
        ...
        public bool Delete(int idItem)
        {
            try
            {
                var entry = _sisGmaEntities.Regiones.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
