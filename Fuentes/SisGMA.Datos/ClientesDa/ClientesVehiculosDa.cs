...
namespace SisGMA.Datos
{
    ...
    public class ClientesVehiculosDa : BaseEntity
    {
        private readonly SisGMAEntities _sisGmaEntities;

        public ClientesVehiculosDa()
        {
            IsValid = true;
        ...
        public ClientesVehiculos Insert(ClientesVehiculos item)
        {
            try
            {
                _sisGmaEntities.ClientesVehiculos.Add(item);
        ...
        public ClientesVehiculos Get(int idItem)
        {
            try
            {
                return _sisGmaEntities.ClientesVehiculos.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public List<ClientesVehiculos> GetAll()
        {
            try
            {
                return _sisGmaEntities.ClientesVehiculos.ToList();
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public ClientesVehiculos Update(ClientesVehiculos item)
        {
            try
            {
                _sisGmaEntities.ClientesVehiculos.Attach(item);
        ...
        public bool Delete(int idItem)
        {
            try
            {
                var entry = _sisGmaEntities.ClientesVehiculos.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
