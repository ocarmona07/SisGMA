...
namespace SisGMA.Datos
{
    ...
    public class ComunasDa : BaseEntity
    {
        ...
        public Comunas Insert(Comunas item)
        {
            try
            {
                _sisGmaEntities.Comunas.Add(item);
        ...
        public Comunas Get(int idItem)
        {
            try
            {
                return _sisGmaEntities.Comunas.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public Comunas Update(Comunas item)
        {
            try
            {
                _sisGmaEntities.Comunas.Attach(item);
        ...
        public bool Delete(int idItem)
        {
            try
            {
                var entry = _sisGmaEntities.Comunas.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
