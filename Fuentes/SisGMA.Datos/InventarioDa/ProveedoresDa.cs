...
namespace SisGMA.Datos
{
    ...
    public class ProveedoresDa : BaseEntity
    {
        ...
        public Proveedores Insert(Proveedores item)
        {
            try
            {
                _sisGmaEntities.Proveedores.Add(item);
        ...
        public Proveedores Get(int idItem)
        {
            try
            {
                return _sisGmaEntities.Proveedores.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public List<Proveedores> GetAll()
        {
            try
            {
                return _sisGmaEntities.Proveedores.ToList();
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public Proveedores Update(Proveedores item)
        {
            try
            {
                _sisGmaEntities.Proveedores.Attach(item);
        ...
        public bool Delete(int idItem)
        {
            try
            {
                var entry = _sisGmaEntities.Proveedores.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
