...
namespace SisGMA.Datos
{
    ...
    public class GastosDiariosDa : BaseEntity
    {
        private readonly SisGMAEntities _sisGmaEntities;

        public GastosDiariosDa()
        {
            IsValid = true;
        ...
        public GastosDiarios Insert(GastosDiarios item)
        {
            try
            {
                _sisGmaEntities.GastosDiarios.Add(item);
        ...
        public GastosDiarios Get(int idItem)
        {
            try
            {
                return _sisGmaEntities.GastosDiarios.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public List<GastosDiarios> GetAll()
        {
            try
            {
                return _sisGmaEntities.GastosDiarios.ToList();
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public GastosDiarios Update(GastosDiarios item)
        {
            try
            {
                _sisGmaEntities.GastosDiarios.Attach(item);
        ...
        public bool Delete(int idItem)
        {
            try
            {
                var entry = _sisGmaEntities.GastosDiarios.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
