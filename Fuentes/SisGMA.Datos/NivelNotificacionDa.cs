...
namespace SisGMA.Datos
{
    ...
    public class NivelNotificacionDa : BaseEntity
    {
        private readonly SisGMAEntities _sisGmaEntities;

        public NivelNotificacionDa()
        {
            IsValid = true;
        ...
        public NivelNotificacion Insert(NivelNotificacion item)
        {
            try
            {
                _sisGmaEntities.NivelNotificacion.Add(item);
        ...
        public NivelNotificacion Get(int idItem)
        {
            try
            {
                return _sisGmaEntities.NivelNotificacion.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public List<NivelNotificacion> GetAll()
        {
            try
            {
                return _sisGmaEntities.NivelNotificacion.ToList();
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public NivelNotificacion Update(NivelNotificacion item)
        {
            try
            {
                _sisGmaEntities.NivelNotificacion.Attach(item);
        ...
        public bool Delete(int idItem)
        {
            try
            {
                var entry = _sisGmaEntities.NivelNotificacion.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
