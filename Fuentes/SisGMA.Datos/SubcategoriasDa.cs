...
namespace SisGMA.Datos
{
    ...
    public class SubcategoriasDa : BaseEntity
    {
        private readonly SisGMAEntities _sisGmaEntities;

        public SubcategoriasDa()
        {
            IsValid = true;
        ...
        public Subcategorias Insert(Subcategorias item)
        {
            try
            {
                _sisGmaEntities.Subcategorias.Add(item);
        ...
        public Subcategorias Get(int idItem)
        {
            try
            {
                return _sisGmaEntities.Subcategorias.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public List<Subcategorias> GetAll()
        {
            try
            {
                return _sisGmaEntities.Subcategorias.ToList();
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public Subcategorias Update(Subcategorias item)
        {
            try
            {
                _sisGmaEntities.Subcategorias.Attach(item);
        ...
        public bool Delete(int idItem)
        {
            try
            {
                var entry = _sisGmaEntities.Subcategorias.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
