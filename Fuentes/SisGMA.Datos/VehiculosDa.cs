...
namespace SisGMA.Datos
{
    ...
    public class VehiculosDa : BaseEntity
    {
        ...
        public Vehiculos Insert(Vehiculos item)
        {
            try
            {
                _sisGmaEntities.Vehiculos.Add(item);
        ...
        public Vehiculos Get(int idItem)
        {
            try
            {
                return _sisGmaEntities.Vehiculos.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public List<Vehiculos> GetAll()
        {
            try
            {
                return _sisGmaEntities.Vehiculos.ToList();
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public Vehiculos Update(Vehiculos item)
        {
            try
            {
                _sisGmaEntities.Vehiculos.Attach(item);
        ...
        public bool Delete(int idItem)
        {
            try
            {
                var entry = _sisGmaEntities.Vehiculos.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
