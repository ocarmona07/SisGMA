...
namespace SisGMA.Datos
{
    ...
    public class ProvinciasDa : BaseEntity
    {
        ...
        public Provincias Insert(Provincias item)
        {
            try
            {
                _sisGmaEntities.Provincias.Add(item);
        ...
        public Provincias Get(int idItem)
        {
            try
            {
                return _sisGmaEntities.Provincias.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
            }
            catch (EntryPointNotFoundException ep)
            {
                IsValid = false;
        ...
        public Provincias Update(Provincias item)
        {
            try
            {
                _sisGmaEntities.Provincias.Attach(item);
        ...
        public bool Delete(int idItem)
        {
            try
            {
                var entry = _sisGmaEntities.Provincias.FirstOrDefault(o => o.IdCliente == idItem); // TODO: Reemplazar Id
